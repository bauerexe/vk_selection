...
const (
	PubSub_Subscribe_FullMethodName = "/api.pubsub.v1.PubSub/Subscribe"
	PubSub_Publish_FullMethodName   = "/api.pubsub.v1.PubSub/Publish"
)

// PubSubClient is the client API for PubSub usecase.
//
...
// PubSubServer is the server API for PubSub usecase.
...
// UnsafePubSubServer may be embedded to opt out of forward compatibility for this usecase.
...
// PubSub_ServiceDesc is the grpc.ServiceDesc for PubSub usecase.
// It's only intended for direct use with grpc.RegisterService,
// and not to be introspected or modified (even as a copy)
var PubSub_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "api.pubsub.v1.PubSub",
	...
	Metadata: "api/pubsub/v1/pubsub.proto",
}
